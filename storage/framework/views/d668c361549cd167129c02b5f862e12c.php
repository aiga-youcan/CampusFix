...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center space-x-2">
            ...
            <form action="<?php echo e(route('signalements.destroy', $signalement->id)); ?>" method="POST" onsubmit="return confirm('Wach bġiti bṣaḥ t-mḥa had l-signalement?');">
                <?php echo csrf_field(); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                ...
                <div class="space-y-3 text-xs pt-1">
                    <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200">
                        ...
                        <p class="text-slate-600 leading-relaxed"><?php echo e($signalement->ai_diagnostic ?? 'Analyse standard effectuée.'); ?></p>
                    </div>

                    <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200">
                        <strong class="text-slate-900 block mb-1 font-semibold">Action d'intervention recommandée :</strong>
                        <p class="text-slate-600 leading-relaxed"><?php echo e($signalement->ai_recommended_action ?? 'Planifier l\'intervention selon les disponibilités.'); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6">
            <?php if(auth()->user()?->hasRole('technicien')): ?>
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
